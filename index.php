...
if (isset($update['callback_query'])) {
    ...
    switch ($data) {
        ...
        case 'create_match':
            ...
            break;
        case 'find_match':
            $tournaments = $telegram->getAvailableTournaments($chatId);
...
2. <u>Система начисления баллов:</u>
    <b>Игра с ботом:</b>
    - За победу: +2 балла
    - За проигрыш: -1 балл
    - За ничью: 0 балов
    ...
    - За проигрыш: -1 бал
    - За ничью: 0 баллов
    - За организацию поединка: -1 балл (снимается с игрока, создавшего поединок)
3. <u>Минимальное количество балов:</u>
...
4. <u>Создание поединка:</u>
    - Наименование может содержать:
        ...
        $list любой пробельный символ (включает пробел, табуляцию и другие пробельные символы);
        $list длина строки от 1 до 15 символов.
    - Первый игрок создает поединок, делает свой выбор и теряет 1 бал за организацию поединка.
